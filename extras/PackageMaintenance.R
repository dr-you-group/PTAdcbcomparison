...
OhdsiRTools::checkUsagePackage("PTAdcbcomparison")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/PTAdcbcomparison.pdf")
shell("R CMD Rd2pdf ./ --output=extras/PTAdcbcomparison.pdf")
...
OhdsiRTools::createRenvLockFile("PTAdcbcomparison")
